    ...
    <div className={styles.aboutUs}>
      ...
      <section className={styles.staff}>
        ...
        <p className={`${styles.staff__text} ${styles.staff__text_text1}`}>
          ...
          have been making music for more than 5 years, but I have been burning
          with it all my life, I work on a regular basis with such artists as
          ‘Milan’, ‘Field’, ‘Your Bunny Writes’.
        </p>
        ...
        <p className={`${styles.staff__text} ${styles.staff__text_text2}`}>
          ...
          went to study in Kyiv to various specialists, the best in their field.
          Now I live in Lviv and work here, I will be happy to help you in
          creating your songs.
        </p>
      </section>
      ...
      <section className={styles.history}>
        ...
        <article className={styles.history__article2}>
          ...
          <p className={styles.history__art2Text_text2}>
            !!Second!! I am very pleased with the recording! The sound is clear,
            without noise, and
          </p>
        </article>
        ...
        <article className={styles.history__article3}>
          <p className={styles.history__art3Text}>
            ...
            Ukrainian musicians to share their work with the world while making
            a positive impact.
          </p>
        </article>
      ...
      <section className={styles.staff}>
        ...
        <p className={`${styles.staff__text} ${styles.staff__text_text2}`}>
          I teach both from scratch, giving the basics of hand placement, sound
          production, the basics of musical literacy, and guitarists with
          experience, adjusting and improving their technical and theoretical
          skills.
        </p>
      </section>
