            ...
            <Form className={styles.form}>
                ...
                >
                    <p className={styles.form__checkboxLabel}>
                        <Trans
                            ...
                            components={{
                                underlined: (
                                    <span onClick={handlePolicyClick} style={{textDecoration: 'underline', marginInline: '5px', cursor: 'pointer'}}>{privatePolicy}</span>
                                ),
                            }}
                        />
                ...
                <button
                        className={`${styles.form__button} ${
                            (isSubmitting || !isValid || !values.termsAccepted) && styles.form__button_disabled
                        } ${cn({
